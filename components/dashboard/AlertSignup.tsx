  ...
  return (
    <section style={{ padding: '3rem 0' }}>
      <div className="container-main">
        <div style={{
          background: 'linear-gradient(135deg, rgba(59,130,246,0.06) 0%, rgba(239,68,68,0.06) 100%)',
          ...
          <div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'0.5rem' }}>
              {['New confirmed outbreaks worldwide', 'Death toll milestones & spikes', 'CDC/WHO travel advisory changes', 'Weekly intelligence briefing'].map((item) => (
              ...
              <form onSubmit={handleSubmit}>
                <div style={{ background:'var(--bg-secondary)', border:'1px solid var(--border-glass)', borderRadius:'var(--radius-xl)', padding:'2rem', display:'flex', flexDirection:'column', gap:'1rem' }}>
                  ...
                  <p style={{ fontFamily:'var(--font-ui)', fontSize:'0.68rem', color:'var(--text-muted)', textAlign:'center', lineHeight:1.5 }}>
                    No spam. Unsubscribe anytime. Alerts sourced from WHO, CDC & ECDC only.
                  </p>
                </div>
              </form>
            )}
